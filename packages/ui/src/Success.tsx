...
export default function Success({ person, setStatus, amount }: { person: any; setStatus: (status: 'success' | 'idle' | 'error') => void; amount: string; }) {
    ...
    return (
        ...
        >
            ...
            >
                ...
                >
                    You successfully sent <span className="font-bold text-gray-800">${amount || '0.00'}</span> to {recipient.name}.
                </motion.p>
                ...
                >
                    ...
                    <div>
                        ...
                        <p className="text-xs text-gray-500 text-left">Transaction Complete</p>
                    </div>
                </motion.div>
                ...
                <motion.button
                    onClick={() => setStatus('idle')}
                    className="w-full bg-green-500 text-white font-bold py-3 px-6 rounded-full mt-10 shadow-lg shadow-green-500/30 transform hover:scale-105 hover:shadow-xl transition-all duration-300"
                    initial={{ opacity: 0, y: 20 }}
